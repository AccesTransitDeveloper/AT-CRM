export const en = {
  ...
  nav: {
    drivers: "Drivers",
    driversSub: "Fleet & Onboarding",
    orders: "Orders",
    ordersSub: "Dispatch & Routes",
    brokers: "Brokers & MTA",
    brokersSub: "TripLink & MyLe",
    support: "Support",
    supportSub: "Tickets & Live Chat",
    finance: "Finance (15%)",
    financeSub: "Ledger & Settlements",
    api: "AT AI & API",
    apiSub: "REST & Webhooks",
